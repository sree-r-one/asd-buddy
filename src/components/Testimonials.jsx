    ...
    <div className="overflow-hidden">
      <div className="relative mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        ...
        <div className="mb-6 w-3/4 max-w-2xl sm:mb-10 md:mb-16 lg:w-1/2">
          <h2 className="text-2xl font-semibold text-black sm:text-3xl lg:text-4xl">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="flex h-auto">
            <div className="flex flex-col rounded-xl bg-white dark:bg-neutral-900">
              <div className="flex-auto p-4 md:p-6">
                <p className="text-base italic text-gray-800 md:text-lg dark:text-neutral-200">
              ...
              <div className="rounded-b-xl bg-gray-100 p-4 md:px-7 dark:bg-neutral-800">
                <div className="flex items-center gap-x-3">
                  ...
                  <div className="grow">
                    <p className="text-sm font-semibold text-gray-800 sm:text-base dark:text-neutral-200">
                      Josh Tyson
                    </p>
